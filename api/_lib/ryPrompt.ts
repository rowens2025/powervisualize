...
const PATH_REGISTRY: Record<string, { name: string; blurb: string }> = {
  ...
  '/dashboards': { name: 'the Dashboards gallery', blurb: "a gallery of Ryan's earlier-career Power BI and BI dashboards (several roughly four to seven years old), kept to show where his journey started — his current core strengths live on the Data Projects page" },
